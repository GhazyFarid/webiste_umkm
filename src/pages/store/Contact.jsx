      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-primary font-bold uppercase tracking-widest block mb-4">Hubungi Kami</span>
            <h1 className="text-4xl md:text-6xl font-display font-extrabold text-slate-900 mb-6">Let's Get in Touch</h1>
            <p className="text-slate-500 max-w-2xl mx-auto lg:text-lg">
              Punya pertanyaan atau ingin diskusi lebih lanjut? Kami siap membantu Anda kapanpun dibutuhkan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-8 md:p-12 rounded-[40px] border border-slate-100 shadow-xl shadow-slate-200/50">
                <h3 className="text-2xl font-display font-bold mb-8">Kirim Pesan</h3>
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-slate-600 uppercase tracking-wide">Nama</label>
                      <input 
                        type="text" 
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-600 uppercase tracking-wide">Subjek</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-600 uppercase tracking-wide">Pesan</label>
                    <textarea 
